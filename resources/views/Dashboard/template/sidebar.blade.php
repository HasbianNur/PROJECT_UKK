...
<nav class="nav flex flex-column">
    <ul class="nav__menus flex flex-column mb-14">
        ...
        <li class="mt-8 mb-3">
            <a class="nav__menu {{ Request::is('dashboard') ? 'active' : '' }} flex flex-align-center"
                href="/dashboard">
        ...
        <li class="mb-3">
            <a class="nav__menu {{ Request::is('dashboard/barang-lelang') ? 'active' : '' }} flex flex-align-center"
                href="/dashboard/barang-lelang">
